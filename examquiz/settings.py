...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-examquiz-dev-key-change-in-production')
...
# Falls back to SQLite if PostgreSQL credentials are not provided
